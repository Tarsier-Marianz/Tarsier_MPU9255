/*
  ...
  Reference for Kalman: http://www.bzarg.com/p/how-a-kalman-filter-works-in-pictures/
*/
...
void initKalmanFilter() {
  ...
  double roll  = atan2(mpu._AX, mpu._AZ) * RAD_TO_DEG;
  double pitch = atan(-mpu._AX / sqrt(mpu._AY * mpu._AY + mpu._AZ * mpu._AZ)) * RAD_TO_DEG;
